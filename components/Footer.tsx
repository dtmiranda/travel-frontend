...
export default function Footer(){
  return(
    <footer className="bg-green-900 border-green-200 px-4 py-6 mt-10 lg:px-8">
      <div className="mx-auto max-w-screen-xl px-4 md:px-4">
        <div className="md:flex md:justify-between ">
            <div className="mb-6 md:mb-0">
                <a href="#" className="flex items-center">
                    <span className="self-center text-white text-2xl font-semibold whitespace-nowrap">TravelNorth</span>
                </a>
            </div>
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2">
                
                <div>
                    <h2 className="mb-6 text-sm font-semibold text-green-900 uppercase">Follow us</h2>
