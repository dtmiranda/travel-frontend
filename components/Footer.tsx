...
export default function Footer(){
  return(
    <footer className="bg-white border-green-200 px-4 py-6 mt-10 lg:px-8 dark:bg-green-900">
      <div className="mx-auto max-w-screen-xl px-4 md:px-4">
        <div className="md:flex md:justify-between ">
            <div className="mb-6 md:mb-0">
                <a href="#" className="flex items-center">
                    <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">TravelNorth</span>
                </a>
            </div>
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2">
                
                <div>
                    <h2 className="mb-6 text-sm font-semibold text-green-900 uppercase dark:text-white">Follow us</h2>
                ...
                <div>
                    <h2 className="mb-6 text-sm font-semibold text-green-900 uppercase dark:text-white">Legal</h2>
                    <ul className="text-green-600 dark:text-green-400">
                        <li className="mb-4">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-green-500 sm:text-center dark:text-green-400">© 2022 <a href="#" className="hover:underline">TravelNorth™</a>. All Rights Reserved.
            </span>
            <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            <a href="#" className="text-green-500 hover:text-green-900 dark:hover:text-white">
