...
export default function Footer(){
  return(
    <footer className="bg-white border-gray-200 px-4 py-6 mt-10 lg:px-8 dark:bg-gray-900">
      <div className="mx-auto max-w-screen-xl px-4 md:px-4">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="#" className="hover:underline">TravelNorth™</a>. All Rights Reserved.
            </span>
