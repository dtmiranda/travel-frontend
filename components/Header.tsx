  ...
  return(
    <nav className="bg-white border-gray-200 py-6 dark:bg-gray-900 ">
      ...
      <div className="flex items-center md:order-2">
        <a href="/login" className="text-white bg-blue-700 hover:bg-blue-800  font-medium rounded-lg text-sm px-4 py-2 md:px-5 md:py-2.5 mr-1 md:mr-2  focus:outline-none">Login</a>
