          ...
          <div className="relative p-4 bg-white rounded-lg shadow  sm:p-5">
            ...
            <div className="grid gap-4 mb-4 sm:grid-cols-2">
              ...
              <div>
                ...
                <input type="text" name="site" id="site" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-600 focus:border-green-600 block w-full py-5" placeholder="Website" />
              </div>
              ...
              <div className="sm:col-span-2">
                ...
                <textarea id="description" className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-green-500 focus:border-green-500" placeholder="Write Restaurant description here"></textarea>
              </div>
            </div>
